...
export const TRANSLATIONS = {
  ...
  uk: {
    tagline: "Говори. Не тільки вивчай.",
    homeSubtitle: "Вивчай мову, дійсно розмовляючи нею",
  ...
  ro: {
    tagline: "Vorbește-o. Nu doar o studia.",
    homeSubtitle: "Învață o limbă chiar vorbind-o",
  ...
  el: {
    tagline: "Μίλησέ το. Μην το μελετάς μόνο.",
    homeSubtitle: "Μάθε μια γλώσσα μιλώντας την πραγματικά",
